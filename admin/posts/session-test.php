...
echo "<h1>Posts Session Test</h1>";

// Set a test session variable from posts directory
$_SESSION['test_from_posts'] = 'Session data from posts - ' . date('Y-m-d H:i:s');
...
echo "<p><a href='index.php'>Go to Posts Management</a></p>";
?>
