...
echo "<h1>Media Session Test</h1>";

// Set a test session variable from media directory
$_SESSION['test_from_media'] = 'Session data from media - ' . date('Y-m-d H:i:s');
...
echo "<p><a href='index.php'>Go to Media Management</a></p>";
?>
