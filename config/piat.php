<?php
// Piat Campus Configuration
define('CAMPUS_ID', 7);
define('CAMPUS_NAME', 'Piat Campus');
define('CAMPUS_CODE', 'piat');
define('CAMPUS_DOMAIN', 'piat.csu.edu.ph');
define('CAMPUS_FULL_NAME', 'Cagayan State University - Piat Campus');
define('CAMPUS_ADDRESS', 'Piat, Cagayan Valley, Philippines');
define('CAMPUS_PHONE', '+63 XXX XXX XXXX');
define('CAMPUS_EMAIL', 'info@piat.csu.edu.ph');
define('CAMPUS_UPLOAD_PATH', __DIR__ . '/../uploads/');
define('CAMPUS_CACHE_PATH', __DIR__ . '/../cache/');
define('CAMPUS_LOG_PATH', __DIR__ . '/../logs/');
define('CAMPUS_PRIMARY_COLOR', '#be185d');
define('CAMPUS_SECONDARY_COLOR', '#f59e0b');
define('CAMPUS_LOGO_PATH', '/assets/img/campuses/piat-logo.png');
define('CAMPUS_FAVICON_PATH', '/assets/img/campuses/piat-favicon.ico');
