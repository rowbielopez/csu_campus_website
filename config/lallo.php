<?php
// Lallo Campus Configuration
define('CAMPUS_ID', 5);
define('CAMPUS_NAME', 'Lallo Campus');
define('CAMPUS_CODE', 'lallo');
define('CAMPUS_DOMAIN', 'lallo.csu.edu.ph');
define('CAMPUS_FULL_NAME', 'Cagayan State University - Lallo Campus');
define('CAMPUS_ADDRESS', 'Lallo, Cagayan Valley, Philippines');
define('CAMPUS_PHONE', '+63 XXX XXX XXXX');
define('CAMPUS_EMAIL', 'info@lallo.csu.edu.ph');
define('CAMPUS_UPLOAD_PATH', __DIR__ . '/../uploads/');
define('CAMPUS_CACHE_PATH', __DIR__ . '/../cache/');
define('CAMPUS_LOG_PATH', __DIR__ . '/../logs/');
define('CAMPUS_PRIMARY_COLOR', '#0891b2');
define('CAMPUS_SECONDARY_COLOR', '#f59e0b');
define('CAMPUS_LOGO_PATH', '/assets/img/campuses/lallo-logo.png');
define('CAMPUS_FAVICON_PATH', '/assets/img/campuses/lallo-favicon.ico');
